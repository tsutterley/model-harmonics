        ...
        server.retrieve(
            {
                ...
                'levtype': 'sfc',
                'param': (
                    '27.128/28.128/29.128/30.128/74.128/129.128/160.128/'
...
def arguments():
    ...
    parser.add_argument(
        ...
        '-U',
        type=str,
        default=os.environ.get('ECMWF_API_URL'),
        help='ECMWF api url',
    )
    parser.add_argument(
        '--api-key',
        '-K',
        type=str,
        default=os.environ.get('ECMWF_API_KEY'),
        help='ECMWF api key',
    )
    parser.add_argument(
        '--api-email',
        '-E',
        type=str,
        default=os.environ.get('ECMWF_API_EMAIL'),
...
def main():
    ...
    server = ECMWFDataServer(
        url=args.api_url, key=args.api_key, email=args.api_email
    )
