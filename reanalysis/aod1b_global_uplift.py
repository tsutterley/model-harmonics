...
CALLING SEQUENCE:
    python aod1b_uplift.py --release RL06
...
# and oceanic loading
def aod1b_global_uplift(base_dir,
    DREL='',
    YEAR=None,
    LOVE_NUMBERS=0,
    REFERENCE=None,
    ...
    # data product and output units
    DSET = 'glo'
    product = 'Global atmospheric and oceanic loading'
    UNITS = 'mmCU'
    # attributes for output files
    attributes = dict(ROOT={})
    attributes['ROOT']['title'] = product
...
def main():
    ...
    try:
        ...
        output_files = aod1b_global_uplift(args.directory,
            DREL=args.release,
            YEAR=args.year,
