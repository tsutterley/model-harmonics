...
def era5_land_mean_monthly(
    base_dir, RANGE=None, DATAFORM=None, VERBOSE=False, MODE=0o775
):
    # create logger
    ...
    if DATAFORM == 'ascii':
        # ascii (.txt)
        tws_mean.to_ascii(output_file, date=False, verbose=VERBOSE)
        ...
        # HDF5 (.H5)
        tws_mean.to_HDF5(output_file, verbose=VERBOSE, date=False, **attributes)
