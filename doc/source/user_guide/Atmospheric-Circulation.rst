...
.. graphviz::
    ...
    digraph {
        ...
        O [label="Model Orography"
            ...
            style="filled"
            color="#7570b3"]
        M [URL="https://github.com/tsutterley/model-harmonics/blob/main/model_harmonics/TWS/reanalysis_mean_pressure.py"
            ...
            style="filled"
            color="gray"]
        H [URL="https://github.com/tsutterley/model-harmonics/blob/main/model_harmonics/TWS/reanalysis_pressure_harmonics.py"
...
.. graphviz::
    ...
    digraph {
        E [label="Reanalysis Temperature\nand Specific Humidity"
            ...
            style="filled"
            color="#7570b3"]
        L [URL="https://github.com/tsutterley/model-harmonics/blob/main/model_harmonics/TWS/model_level_coefficients.py"
            label="Model Level\nCoefficients"
            fontname="Lato"
            fontsize=11
            shape=box
        ...
        O [label="Model Orography"
            ...
            style="filled"
            color="#7570b3"]
        G [URL="https://github.com/tsutterley/model-harmonics/blob/main/model_harmonics/TWS/reanalysis_geopotential_heights.py"
            ...
            style="filled"
            color="gray"]
        M [URL="https://github.com/tsutterley/model-harmonics/blob/main/model_harmonics/TWS/reanalysis_mean_harmonics.py"
            label="Calculate Temporal Mean\nSpherical Harmonics"
            fontname="Lato"
            fontsize=11
            shape=box
            style="filled"
            color="gray"]
        H [URL="https://github.com/tsutterley/model-harmonics/blob/main/model_harmonics/TWS/reanalysis_atmospheric_harmonics.py"
            label="Calculate Spherical Harmonics"
            fontname="Lato"
            fontsize=11
            shape=box
