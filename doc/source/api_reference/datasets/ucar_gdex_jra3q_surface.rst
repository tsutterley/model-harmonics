...
.. __: https://github.com/polargeodesy/model-harmonics/blob/main/model_harmonics/datasets/ucar_gdex_jra3q_surface.py

Calling Sequence
################

.. argparse::
    :module: model_harmonics.datasets.ucar_gdex_jra3q_surface
    :func: arguments
    :prog: ucar_gdex_jra3q_surface.py
    :nodescription:
    :nodefault:
