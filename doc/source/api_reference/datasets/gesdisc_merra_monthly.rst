...
.. __: https://github.com/tsutterley/model-harmonics/blob/main/model_harmonics/datasets/gesdisc_merra_monthly.py

Calling Sequence
################

.. argparse::
    :module: model_harmonics.datasets.gesdisc_merra_monthly
    :func: arguments
