...
- Reads atmospheric geopotential heights fields from reanalysis and calculates sets of spherical harmonics using a 3D geometry :cite:p:`Boy:2005el` :cite:p:`Swenson:2002kf`
