...
CALLING SEQUENCE:
    python jpl_ecco_realtime_sync.py --user <username> kf080i
...
def jpl_ecco_realtime_sync(
    ...
    if LOG:
        ...
        logger.info(f'ECCO Near Real-Time {PRODUCT} Sync Log ({today})')
    ...
    for yr in years:
        ...
        for sd in subdirs:
            ...
            local_dir = DIRECTORY.joinpath(yr, sd)
            # check if directory exists and recursively create if not
